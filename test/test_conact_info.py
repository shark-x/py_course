...
def test_contact_info_on_home_page(app):
    ...
    # assert contact_info_on_hp.address == contact_info_on_ep.address
    # assert contact_info_on_hp.all_phones_from_home_page == merge_phones_like_on_home_page(contact_info_on_ep)
    # assert contact_info_on_hp.all_emails_from_home_page == contact_info_on_ep.all_emails_from_home_page
